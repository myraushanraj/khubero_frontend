...
const Stake = ({data, verifyTransaction, writeContractFunction, initValue}) =>{
    ...
    withdrawReward = async() =>{
        const stakeContract = await writeContractFunction('KBR');
            ...
            <Row className="g-5">
                ...
                <Col xl='6'>
                    <Row className="g-5">
                       ...
                       { data.userAllowReward && <Col>
                            <div className="d-flex justify-content-center">
                                <div className='buttonWrapper mt-0'>
  <button  onClick={withdrawReward} disabled = {!data.userAllowReward}> Withdraw Reward</button>
                               </div>
                            </div>
                        </Col>}
                    </Row>
